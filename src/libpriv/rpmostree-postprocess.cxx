...
rpmostree_compose_commit (int            rootfs_fd,
                          ...
                          GVariant      *src_detached_metadata,
                          ...
                          GError       **error)
{
  ...
  if (src_detached_metadata != NULL)
    {
      g_autoptr(GVariantDict) detached_metadata_dict = g_variant_dict_new (src_detached_metadata);
      g_autoptr(GVariant) detached_metadata = g_variant_dict_end (detached_metadata_dict);
