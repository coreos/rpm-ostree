...
static RpmOstreeCommand commands[] = {
...
#endif
  { "cleanup", RPM_OSTREE_BUILTIN_FLAG_NONE,
  ...
  { "rollback", RPM_OSTREE_BUILTIN_FLAG_NONE,
  ...
  { "initramfs", RPM_OSTREE_BUILTIN_FLAG_NONE,
    rpmostree_builtin_initramfs },
  { "install", RPM_OSTREE_BUILTIN_FLAG_NONE,
    rpmostree_builtin_install },
  { "uninstall", RPM_OSTREE_BUILTIN_FLAG_NONE,
