                                     ...
                                     GError       **error)
{
  ...
  self->pkgcache_repo = ostree_repo_open_at (AT_FDCWD, opt_pkgcache_repo, cancellable, error);
    ...
    GLNX_HASH_TABLE_FOREACH_IT (pkg_to_objidxattrs, it, DnfPackage*, pkg, GPtrArray *,objidxattrs)
      {
        ...
        if (!glnx_file_replace_contents_at (oirpm_tmpd.fd, path, g_variant_get_data (objid_xattrs_final),
